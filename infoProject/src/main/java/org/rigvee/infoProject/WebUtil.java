package org.rigvee.infoProject;
...
//	}
	...
	public void windoHandlesByUrl(String Url_Of_Next_Window) {
		try {
			...
			for(String handleValue:all_handle_value) {
				...
				if(driver.getCurrentUrl().contains(Url_Of_Next_Window)) {
					break;
				}
			}
	 ...
	 */
	public void take_ParticularElementScreenShot(WebElement webElement,String path)  {
		try {
	 ...
	 */
	public void validateTitleContains(String expTitle,String message) throws InterruptedException {
		String actTitle=getTitle();
		if(!actTitle.contains(expTitle)) {
			String errMessage=message+" Actual :"+actTitle+" Expected :"+expTitle;
	...
	public void validateTitleEquals(String expectedTitle,String message)  {
		...
		if(!actTitle.equals(expectedTitle)) {
			String errMessage=message+":  Validation Failed, "+" Actual :"+actTitle+", Expected :"+expectedTitle;
	...
	public void validateURLContains(String ExpectedURL,String message) {
		...
		if(actUrl.contains(ExpectedURL)==true) {
			System.out.println(message+" :  Validation Passed  ");
		}else {
			String errMessage=message+" :  Validation Failed "+" Actual :"+actUrl+" Expected :"+ExpectedURL;
			System.out.println(errMessage);
		}
	 ...
	 *@param message String to the send message of element 
	 */
	public void validateGetTextequals(WebElement webElement,String Expected,String message) throws InterruptedException {
		String actText=getText(webElement);
		if(!actText.equals(Expected)) {
			String errMessage="Actual :"+actText+" Expected :"+Expected;
			System.out.println(message+" : Validation Faile : "+errMessage);
			throw new AssertionError(errMessage);
		}
		System.out.println("Validation Passed  : "+message);
	}
	...
	public void validateGetTextContains(WebElement webElement,String Expected,String message) {
		String actText=getText(webElement);
		if(!actText.contains(Expected)) {
			String errMessage=message+" : Actual :"+actText+" Expected :"+Expected;
			System.out.println("Validation Failed : "+errMessage);
			throw new AssertionError(errMessage);
		}
		System.out.println("Validation Passed  : "+message);
	...
	public void validateIsEnabled(WebElement webElement,String message) {
		...
		if(actEnable==true) {
			...
			String errorMessage="Element is not Enable on the page : "+actEnable;
	...
	public void validateIsSelected(WebElement webElement,String message) {
		...
		if(!actSelected==true) {
			System.out.println(message+" :  Element is not Selected on Webpage : "+actSelected);
		}else {
			System.out.println("Validation Passed : "+message);
		}
	}
	...
	public void validateIsDisplayed(WebElement webElement,String message) {
		...
		if(!Display==true) {
			String errorMessage=message+" :  Element is not Display on Webpage : "+Display;
			System.out.println(errorMessage);
			throw new AssertionError(errorMessage);
		}
	...
	public void validateGetAttributeByEquals(WebElement webElement,String expAttribute,String message) {
		String actAttributeValue=getAttribute(webElement, "value");
		if(actAttributeValue.equals(expAttribute)) {	
			System.out.println("Validation Passed   "+message);
		}else {
			String errorMessage=message+"  Validation Failed >> "+"Actual Value  : "+actAttributeValue+"   ExpValue : "+expAttribute;
			System.out.println(errorMessage);
			throw new AssertionError(errorMessage);
		}
	}
	public void validateGetAttributeByContains(WebElement webElement,String expattributeValue,String message) {
		String actAttributeValue=getAttribute(webElement,"value");
		if(actAttributeValue.contains(expattributeValue)) {
			System.out.println(message+"  Validation Passed ");
		}else {
			String errorMessage=message+"   Validation Failed : "+"act Value : "+actAttributeValue+"expValue : "+expattributeValue;
			System.out.println(errorMessage);
			throw new AssertionError(errorMessage);
